CoolClock.config.skins = {
    ...
    city: {
        // outerBorder:      { lineWidth: 185, radius: 1, color: "#E5ECF9", alpha: 1 },
        smallIndicator:   { lineWidth: 2, startAt: 80, endAt: 90 , color: "white", alpha: 1 },
        largeIndicator:   { lineWidth: 2, startAt: 75, endAt: 90 , color: "white", alpha: 1 },
        hourHand:         { lineWidth: 5, startAt: 0, endAt: 55, color: "#fff", alpha: 1 },
        minuteHand:       { lineWidth: 4, startAt: 0, endAt: 70, color: "#fff", alpha: 1 },
        secondHand:       { lineWidth: 1, startAt: -10, endAt: 70, color: "red", alpha: .85 },
        secondDecoration: { lineWidth: 3, startAt: 0, radius: 2, fillColor: "red", color: "#fff", alpha: 1 }
    }
};